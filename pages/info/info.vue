		...
		<view class="bot">
			...
			<view class="btn">
				<view @tap="audioWayFunc">
					...
					<image v-if="audioWay ==2" class="iconbtn" src="../../static/image/icons/single_loop.png"></image>
					<image v-if="audioWay ==1" class="iconbtn" src="../../static/image/icons/random_play.png"></image>
				</view>
				<view class="palybtn">
					<view @tap="upPlay">
					...
					<view @tap="play">
						<image v-if="!playState" class="iconbtn play" src="../../static/image/icons/start_blank.png">
						</image>
		...
		.content {
			...
			.micImg {
				...
				image {
					...
					width: 600upx;
					height: 600upx;
					border: solid16upx rgba(0, 0, 0, .15);
					border-radius: 50%;

					&.album_rotate {
						transform: rotate(360deg);
						animation: rotation8s linear infinite;
					}
				}
			}
